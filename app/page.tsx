...
export default function DashboardPage() {
  ...
  return (
    <Shell active="/" title="Inventory Health Overview" subtitle={`Stock health across ${rows.length} raw materials · Khatwad plant`} syncLabel={syncLabel} onRefresh={load} refreshing={loading}>
      {error && (
